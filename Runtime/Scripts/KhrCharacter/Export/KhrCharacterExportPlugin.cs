...
namespace UnityGLTF.KhrCharacter
{
    ...
    /// and KHR_character_reference_pose from a Unity character.
    /// 
    ...
    public class KhrCharacterExportPlugin : GLTFExportPlugin
    {
        ...
        public override string Description =>
            ...
            "KHR_character_skeleton_mapping, KHR_character_reference_pose). Facial expressions only; " +
            "body animations export via standard glTF animation.";
